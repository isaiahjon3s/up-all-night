    ...
    demos = [
        {
            ...
            "command": ["python3", "terminalgrapher.py", "x^2"],
            "description": "A simple parabola"
        },
        {
            "title": "Sine Wave: sin(x)",
            "command": ["python3", "terminalgrapher.py", "sin(x)", "--xmin", "-6.28", "--xmax", "6.28", "--ymin", "-2", "--ymax", "2"],
            "description": "A sine wave over two periods"
        },
        {
            "title": "Cubic Function: x³ - 3x",
            "command": ["python3", "terminalgrapher.py", "x^3 - 3*x", "--xmin", "-3", "--xmax", "3", "--ymin", "-10", "--ymax", "10"],
            "description": "A cubic function with local extrema"
        },
        {
            "title": "Logarithmic Function: log(x)",
            "command": ["python3", "terminalgrapher.py", "log(x)", "--xmin", "0.1", "--xmax", "10", "--ymin", "-3", "--ymax", "3"],
            "description": "Natural logarithm function"
        },
        {
            "title": "Square Root: √x",
            "command": ["python3", "terminalgrapher.py", "sqrt(x)", "--xmin", "0", "--xmax", "16", "--ymin", "0", "--ymax", "4"],
            "description": "Square root function"
        },
        {
            "title": "Cosine with Grid: cos(x)",
            "command": ["python3", "terminalgrapher.py", "cos(x)", "--xmin", "-6.28", "--xmax", "6.28", "--ymin", "-2", "--ymax", "2", "--grid"],
            "description": "Cosine wave with grid lines for better visualization"
        },
        {
            "title": "Exponential: e^x",
            "command": ["python3", "terminalgrapher.py", "exp(x)", "--xmin", "-3", "--xmax", "3", "--ymin", "0", "--ymax", "20"],
            "description": "Exponential function"
        },
        {
            "title": "Complex Function: x² + sin(x)",
            "command": ["python3", "terminalgrapher.py", "x^2 + sin(x)", "--xmin", "-4", "--xmax", "4", "--ymin", "-5", "--ymax", "20"],
